...
// * redux
import {selectAuth, selectAuthData, selectIsOpenMobileMenu} from '../redux/user/selectors'
import {useAppDispatch} from '../redux/store'
import {useSelector} from 'react-redux'
import {logout, handleOpenMobileMenu} from '../redux/user/userSlice'
...
const MobileMenu = () => {
    ...
    return (
        <div className={`fixed flex items-center justify-center transition-all py-4 w-full shadow-md px-10 z-40 bg-white ${isOpenMenu ? 'top-20' : 'top-[-10rem]'}`}>
            <AuthLogic/>
        </div>
    )
}
